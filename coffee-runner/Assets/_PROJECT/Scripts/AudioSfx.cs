...
{
    [CreateAssetMenu(fileName = "NewAudioSFX", menuName = "Scriptable Objects/Audio SFX")]
    public class AudioSfx : ScriptableObject
    {
        ...
        public struct AudioParametersStruct
        {
            ...
            public enum AudioPlayMode { Normal, Delayed, OneShot }
        ...
        void PlayAudioInternal(Vector3 position)
        {
            ...
            switch (AudioParameters.playMode)
            {
                case AudioParametersStruct.AudioPlayMode.Normal: _audioSource.Play(); break;
                case AudioParametersStruct.AudioPlayMode.Delayed: _audioSource.PlayDelayed(AudioParameters.StartDelay); break;
                case AudioParametersStruct.AudioPlayMode.OneShot: _audioSource.PlayOneShot(_audioSource.clip); break;
            }
        }
